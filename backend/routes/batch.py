...
def _process_batch(batch_id: str, items: list[tuple[str, bytes, str]], filenames: dict[str, str]) -> None:
    ...
    for item_id, image_bytes, content_type in items:
        ...
        try:
            ...
            response = process_single_image(image_bytes, content_type)
...
async def create_batch(
    ...
    background_tasks.add_task(_process_batch, batch.batch_id, task_items, filenames)
